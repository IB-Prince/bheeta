    ...
    <div className='featured'>
        ...
        <div className='container'>
            ...
            <div className='span-3 img-details'>
                <div className='top'>
                    <h2>123 Acme St. Dallas, Vatara</h2>
                    <p>House for sale</p>
                    <p className='price'>52,677,00</p>
                </div>
            ...
            <div className='span-2 right-img-details'>
                <p>A beautiful modern day in the city with a full-size pool. Spacious and luxurious home located in Texas. Including media room, workout facility, and built-in sauna.</p>
        ...
        <div className='container'>
            ...
            <div className='span-3 img-details order-6'>
                <div className='top'>
                    <h2>123 Acme St. Notun Bazar, Vatara</h2>
                    <p>House for sale</p>
                    <p className='price'>52,677,00</p>
                </div>
                <div className='info-grid'>
